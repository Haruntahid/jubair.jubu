...
export default function HeroSection() {
  ...
  return (
    <section className="pt-28 pb-20 bg-gradient-to-br from-white to-blue-50 dark:from-gray-900 dark:to-gray-800">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="inline-block px-3 py-1 rounded-full bg-blue-100 dark:bg-blue-900 text-primary dark:text-blue-300 font-medium text-sm">
              <span>{profile?.role || "QA Engineer"}</span>
            </div>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold">
              ...
              <span className="block mt-2 text-primary">
                {profile?.tagline?.split(" ").slice(2).join(" ") ||
                  "Through Code & Precision"}
              </span>
            </h1>
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-lg mx-auto lg:mx-0">
              {profile?.bio ||
                "Passionate about finding bugs and ensuring software quality."}
            </p>
            <div className="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-4 justify-center lg:justify-start">
              <a
                href="#contact"
                className="inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-primary hover:bg-blue-700 transition"
              >
                Get in Touch
